...
This is my final project for UCSD's MUS 171. It is an implementation of a multi-channel sequencer using Puredata. The "main" patch that runs everything is `drum_sqncr.pd`.
